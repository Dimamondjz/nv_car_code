...
if(rosbag_make_CONFIG_INCLUDED)
  return()
endif()
set(rosbag_make_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(rosbag_make_SOURCE_PREFIX /home/jz/code/pcd_save/src/rosbag_make)
  set(rosbag_make_DEVEL_PREFIX /home/jz/code/pcd_save/devel)
  set(rosbag_make_INSTALL_PREFIX "")
  set(rosbag_make_PREFIX ${rosbag_make_DEVEL_PREFIX})
else()
  set(rosbag_make_SOURCE_PREFIX "")
  set(rosbag_make_DEVEL_PREFIX "")
  set(rosbag_make_INSTALL_PREFIX /home/jz/code/pcd_save/install)
  set(rosbag_make_PREFIX ${rosbag_make_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'rosbag_make' is deprecated")
...
set(rosbag_make_FOUND_CATKIN_PROJECT TRUE)
...
if(NOT "/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/vtk-6.2;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/jsoncpp;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/tcl " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${rosbag_make_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rosbag_make' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'rosbag_make' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jz/code/pcd_save/src/rosbag_make/${idir}'.  ${_report}")
    endif()
    _list_append_unique(rosbag_make_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND rosbag_make_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND rosbag_make_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT rosbag_make_NUM_DUMMY_TARGETS)
      set(rosbag_make_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::rosbag_make::wrapped-linker-option${rosbag_make_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR rosbag_make_NUM_DUMMY_TARGETS "${rosbag_make_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::rosbag_make::wrapped-linker-option${rosbag_make_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND rosbag_make_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jz/code/pcd_save/devel/lib;/home/jz/lib/realsense/devel/lib;/home/jz/lib/livox_sdk/ws_livox/devel/lib;/opt/ros/kinetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(rosbag_make_LIBRARY_DIRS ${lib_path})
      list(APPEND rosbag_make_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'rosbag_make'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND rosbag_make_LIBRARIES ${lib})
    endif()
  endif()
...
set(rosbag_make_EXPORTED_TARGETS "rosbag_make_generate_messages_cpp;rosbag_make_generate_messages_eus;rosbag_make_generate_messages_lisp;rosbag_make_generate_messages_nodejs;rosbag_make_generate_messages_py")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${rosbag_make_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "geometry_msgs;roscpp;rospy;std_msgs;turtlesim;message_runtime;tf;nav_msgs")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 rosbag_make_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${rosbag_make_dep}_FOUND)
      find_package(${rosbag_make_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rosbag_make_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(rosbag_make_INCLUDE_DIRS ${${rosbag_make_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(rosbag_make_LIBRARIES ${rosbag_make_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${rosbag_make_dep}_LIBRARIES})
  _list_append_deduplicate(rosbag_make_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(rosbag_make_LIBRARIES ${rosbag_make_LIBRARIES})

  _list_append_unique(rosbag_make_LIBRARY_DIRS ${${rosbag_make_dep}_LIBRARY_DIRS})
  list(APPEND rosbag_make_EXPORTED_TARGETS ${${rosbag_make_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "rosbag_make-msg-extras.cmake")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${rosbag_make_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
